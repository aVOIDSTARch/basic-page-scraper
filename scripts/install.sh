...
print_post_install() {
  ...
  printf "%b\n" "${blade}                                                        _.--."
  printf "%b\n" "${blade}                                                   _.-~      ~-._"
  printf "%b\n" "${blade}                                               _.-~    ${white}.${blade}          ~-._"
  printf "%b\n" "${blade}                                           _.-~                     ~--._"
  printf "%b\n" "${blade}                                       _.-~                              \`\`--."
  printf "%b\n" "${blade}                                   _.-~${dark}........${blade}                          \`-."
  printf "%b\n" "${blade}                               _.-~${dark}::::::::::::${blade}~-.                          |"
  printf "%b\n" "${blade}                           _.-~${dark}::::::::::::::::::${blade}~-._                       |"
  printf "%b\n" "${blade}                        .-~${dark}::::::::::::::::::::::::${blade}~-.                     /"
  printf "%b\n" "${blade}                      .~${dark}:::::::${gray}__________${dark}:::::::::::${blade}~-._                /"
  printf "%b\n" "${blade}                     /${dark}::::::::${gray}/          \\\\${dark}::::::::::${blade}~-._           _.-~"
  printf "%b\n" "${blade}                    |${dark}::::::::${gray}|  ${red}O    O${gray}  |${dark}:::::::::::${blade}~--_____--~"
  printf "%b\n" "${blade}                    |${dark}::::::::${gray}|    __    |${dark}::::::${blade}/"
  printf "%b\n" "${blade}                     \\${dark}:::::::${gray}|   \\__/   |${dark}:::::${blade}/"
  printf "%b\n" "${dark}                      \\${dark}::::::${gray}\\\\__________/${dark}::::/${blade}"
  printf "%b\n" "${dark}                       \\${dark}:::::::::::::::::::::/${gray}      ___"
  printf "%b\n" "${dark}                        \\${dark}:::${gray}_____${dark}:::::::::::/${gray}      /   \\\\"
  printf "%b\n" "${dark}                         |${gray}/     \\\\${dark}:::::::::${gray}|      |     |"
  printf "%b\n" "${gray}                         |       |${dark}:::::::${gray}|      |     |"
  printf "%b\n" "${gray}                         |  ${dark}|||${gray}  |${dark}::::::${gray}|       |     |"
  printf "%b\n" "${gray}                         |  ${dark}|||${gray}  |${dark}:::::${gray}|        \\\\___/"
  printf "%b\n" "${gray}                         |       |${dark}::::${gray}|          |"
  printf "%b\n" "${gray}                        /|       |${dark}:::${gray}|           |"
  printf "%b\n" "${gray}                       / |       |${dark}::${gray}|            |"
  printf "%b\n" "${gray}                      /  |  ${dark}~~~${gray}  |${dark}:${gray}|            |"
  ...
  printf "%b\n" "${purple}  ██████  ${blade} ██████ ${cyan} ██████   ${green}  █████  ${yellow} ██████  ${red} ██████  "
  printf "%b\n" "${purple} ██       ${blade}██      ${cyan} ██   ██  ${green} ██   ██ ${yellow} ██   ██ ${red} ██   ██ "
  printf "%b\n" "${purple} ███████  ${blade}██      ${cyan} ██████   ${green} ███████ ${yellow} ██████  ${red} ██████  "
  printf "%b\n" "${purple}      ██  ${blade}██      ${cyan} ██   ██  ${green} ██   ██ ${yellow} ██      ${red} ██   ██ "
  printf "%b\n" "${purple} ██████   ${blade} ██████ ${cyan} ██   ██  ${green} ██   ██ ${yellow} ██      ${red} ██   ██ "
