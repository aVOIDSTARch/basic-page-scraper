...
print_post_install() {
  ...
  printf "%b\n" "${blade}                    \\|  /     \\  |/"
  printf "%b\n" "${blade}                     | ;       ; |"
  printf "%b\n" "${blade}                     | | ${bone}(${red}O${bone}) (${red}O${bone})${blade} | |       ${dark}_______________"
  printf "%b\n" "${blade}                     |  \\  ${bone}___${blade}  /  |      ${dark}/               \\"
  printf "%b\n" "${blade}                      \\  '.${bone}___${blade}.'  /      ${dark}/                 |"
  printf "%b\n" "${blade}                       '.  ${bone}|||${blade}  .'      ${dark}|                  |"
  printf "%b\n" "${gray}                    ___  '.___.'       ${dark}|                  |"
  printf "%b\n" "${gray}                   /   \\    ${dark}|${gray}          ${dark}|                  |"
  printf "%b\n" "${gray}                  /     \\   ${dark}|${gray}          ${dark}|                  |"
  printf "%b\n" "${gray}                 |   _   |  ${dark}|${gray}          ${dark}|                  /"
  printf "%b\n" "${gray}                 |  | |  |  ${dark}|${gray}          ${dark}|                 /"
  printf "%b\n" "${gray}                 |  | |  |  ${dark}|${gray}          ${dark}|                /"
  printf "%b\n" "${dark}                /|  |_|  |\\ ${dark}|${gray}           ${dark}\\              /"
  printf "%b\n" "${dark}               / |       | \\${dark}|${gray}            ${dark}\\            /"
  printf "%b\n" "${dark}              /  |  |||  |  ${dark}|${gray}             ${dark}\\__________/"
  printf "%b\n" "${dark}             /   |  |||  |  ${dark}|"
  printf "%b\n" "${dark}            /    |       |  ${dark}|"
  printf "%b\n" "${dark}           /     |_______|  ${dark}|"
  printf "%b\n" "${dark}          /     /    |    \\ ${dark}|"
